...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting SushiSwap processing");
    
    let mut processor = SushiSwapProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = SushiSwapProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = SushiSwapProcessor::new(false);
